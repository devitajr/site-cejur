                ...
                <div className="container-custom">
                    ...
                    <div id="documentos-constitutivos">
                        <div className="servico-descricao">
                            ...
                            <div className="servico-bloco">
                                <img className="servico-svg" alt="elaboração e revisão" src="IMG/servicos/documentos02.jpg"></img>
                                <div className="servico-nome">
                                    Documentos
                                    Constitutivos
                                    e Auxiliares
                    ...
                    <div id="consultoria-pareceres">
                        <div className="servico-descricao">
                            <div className="servico-bloco">
                                <img className="servico-svg" alt="elaboração e revisão" src="IMG/servicos/pareceres02.jpg"></img>
                    ...
                    <div id="adequacao-lgpd">
                        <div className="servico-descricao">
                            ...
                            <div className="servico-bloco">
                                <img className="servico-svg" alt="elaboração e revisão" src="IMG/servicos/adequacao02.jpg"></img>
                    ...
                    <div id="dpo-service">
                        <div className="servico-descricao">
                            <div className="servico-bloco">
                                <img className="servico-svg" alt="elaboração e revisão" src="IMG/servicos/dpo02.jpg"></img>
